...
exports.getById = function (id, callback) {
  db.getOne('comments', {id: id}, callback);
};
...
exports.getIdListByPostId = function (post_id, page, size, callback) {
  db.getList('comments', page, size, {post_id: post_id}, {timestamp: 'asc'}, ['id'], function (err, list) {
    if (err) return callback(err);
    list = list || [];
...
exports.getIdList = function (page, size, callback) {
  db.getList('comments', page, size, {}, {timestamp: 'asc'}, ['id'], function (err, list) {
    if (err) return callback(err);
    list = list || [];
    list = list.map(function (item) {
      return item.id;
